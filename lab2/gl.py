...
from mate import *
from models import *
from structs import char, word, dword, color
...
#
        ...
        #print(self.background[0][0])


    def glLoad(self, filename, translate=(0, 0, 0), scale=(1,1,1), texture=None, shader=None):
        model = Obj(filename)
        light = V3(0, 0, 1)
        self.shader = shader

        #for e in model.faces:
        #    print(e[0][2])
        ...
        for face in model.faces:
            ...
            if vcount == 3:
                ...
                if texture == None:
                    ...
                    #if model.t_vertices == None:
                    #    self.Triangles(a, c, b, texture=texture, intensity=intensity)
                    #else:
#
    ...
    def Triangles(self, A, B, C, color = None, texture = None, texture_coords=(0,0,0), texture_normal = (0,0,0) , intensity = 1):
        #print(A, B, C)
...
#####     
#####     
#####     r.background_image('./src/caelid.bmp')
#####     
...
#####     
#####     r.glLoad('./src/bear.obj', (0,-3.5,0), (300, 300, 300 ))
#####     
#####     
#####     
